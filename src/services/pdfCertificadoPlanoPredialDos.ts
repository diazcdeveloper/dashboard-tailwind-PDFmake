...
export const generatePDF = async (certificado: Certificado) => {
  ...
  const predio = await loadImageAsBase64("/predioDos.png");
      ...
      },
      {
        table: {
            ...
            body: [
                [
                    {
                        text: "Información Catastral", colSpan: 3, alignment: "center", bold: true, fillColor: "#D3D3D3"
                    }, {}, {}
                ],
                [
                    {
                        text: "Departamento", bold: true, fillColor: "#ADD8E6"
                    },
                    {
                        text: "Referencia catastral terreno anterior", bold: true, fillColor: "#ADD8E6", colSpan: 2
                    }
                ],
                [
                    {
                    ...
                    {
                        text: `${certificado.predial}`, colSpan: 2
                    }
                ],
                [
                    {
                        text: "Municipio", bold: true, fillColor: "#ADD8E6"
                    },
                    {
                        text: "Destino Económico", bold: true, fillColor: "#ADD8E6"
                    },
                    {
                        text: "Matricula", bold: true, fillColor: "#ADD8E6"
                    }
                ],
                [
                    {
                ...
                [
                    {
                        text: "Dirección", bold: true, fillColor: "#ADD8E6"
                    },
                    {
                        text: "Área Terreno", bold: true, fillColor: "#ADD8E6"
                    },
                    {
                        text: "Área Construida", bold: true, fillColor: "#ADD8E6"
                    }
                ],
                [
                    {
      ...
      },
      {
        table: {
          ...
          body: [
            [
              {
                text: "Se expide con las especificaciones técnicas establecidas en el artículo 19 de la resolución conjunta IGAC N° 1101 SNR N° 11344 del 31-12-2020",
                fontSize: 10,
                alignment: "left",
                margin: [10, 10, 10, 10],
              },
