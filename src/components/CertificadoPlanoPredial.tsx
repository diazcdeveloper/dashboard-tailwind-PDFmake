...
import { generatePDF } from "@/services/pdfCertificadoPlanoPredial";
import { Certificado } from "@/types";

const CertificadoPlanoPredial: React.FC = () => {
    ...
    <div>
      ...
      {inscripcion && (
        <div className="flex flex-col gap-2 rounded-sm bg-sky-200 p-5 mt-10 w-fit">
          <h2 className="font-bold text-xl">Certificado Plano Predial Catastral</h2>
          <p>
...
export default CertificadoPlanoPredial;